  ...
  return (
    <Modal open={isModalOpen} onClose={handleCloseModal}>
      ...
      >
        ...
        >
          <Typography variant="h4">Randomisation options</Typography>
          <IconButton color="default" onClick={() => handleCloseModal()}>
            <CloseIcon />
          </IconButton>
        </Stack>
        <Stack sx={{ overflowY: 'auto', p: 2, pt: 0, gap: 2, flex: 1 }}>
          <Stack>
            ...
            <RadioGroup
              ...
              onChange={(_, vul) => {
                setOptions({
                  ...options,
                  percentVulnerable: vulStateToPercent(
                    vul as VulnerabilityState,
                  ),
                });
              }}
            >
